...
class FourthCarouselPage extends Component {
  state = {
    showNavbar: true,
    showPage: true,
    showLogIn: false,
    ...
    return (
      <div className="CarrouselContainer">
        ...
        <div className="CarrouselText">
          <img id="LogoMark" />
          <span className="CompanyName">Others need your help</span>
          <h1 className="Tagline">
            Give a hand to these dog lovers hardworking fellas.
          </h1>
          <p className="Text">
...
export default FourthCarouselPage;
